...
# class MoveItConfigsBuilder_rewrite(ParameterBuilder):
...
#         #print (parameters, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
#         return parameters
...
#     moveit_config = MoveItConfigsBuilder_rewrite("ruka", package_name="ruka").to_moveit_configs()
    
#     #print(MoveItConfigsBuilder_rewrite("ruka", package_name="ruka").robot_description, "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww")
...
#     #print (robot_description, "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq")



#     # #robot_description = {"robot_description": MoveItConfigsBuilder_rewrite("ruka", package_name="ruka").to_moveit_configs.robot_description}
...
#     return LaunchDescription([q , ros2_control_hardware_type])# , control_node joint_state_broadcaster_spawner, robot_controller_spawner
